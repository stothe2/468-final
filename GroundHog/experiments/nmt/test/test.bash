...
SCORE="$GHOG/experiments/nmt/score.py --mode=batch --src=trunc.s --trg=trunc.t --allow-unk"
...
#SAMPLE="$GHOG/experiments/nmt/sample.py --source=trunc.s --beam-search --beam-size 10"
